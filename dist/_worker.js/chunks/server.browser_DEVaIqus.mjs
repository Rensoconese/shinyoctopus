...
function requireServer_browser () {
	if (hasRequiredServer_browser) return server_browser$2;
	...
	server_browser$2.version = l.version;
	server_browser$2.renderToString = l.renderToString;
	server_browser$2.renderToStaticMarkup = l.renderToStaticMarkup;
	server_browser$2.renderToReadableStream = s.renderToReadableStream;
	if (s.resume) {
	  server_browser$2.resume = s.resume;
	}
	return server_browser$2;
}

var server_browserExports = requireServer_browser();
const server_browser = /*@__PURE__*/getDefaultExportFromCjs(server_browserExports);

const server_browser$1 = /*#__PURE__*/_mergeNamespaces({
  __proto__: null,
  default: server_browser
}, [server_browserExports]);

export { server_browser$1 as s };
