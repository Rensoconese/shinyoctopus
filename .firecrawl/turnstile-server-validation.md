[Skip to content](https://developers.cloudflare.com/turnstile/get-started/server-side-validation/#_top)
...
- [JavaScript](https://developers.cloudflare.com/turnstile/get-started/server-side-validation/#tab-panel-6730)
- [PHP](https://developers.cloudflare.com/turnstile/get-started/server-side-validation/#tab-panel-6731)
- [Python](https://developers.cloudflare.com/turnstile/get-started/server-side-validation/#tab-panel-6732)
- [Java](https://developers.cloudflare.com/turnstile/get-started/server-side-validation/#tab-panel-6733)
- [C#](https://developers.cloudflare.com/turnstile/get-started/server-side-validation/#tab-panel-6734)
...
- [Successful response](https://developers.cloudflare.com/turnstile/get-started/server-side-validation/#tab-panel-6735)
- [Failed response](https://developers.cloudflare.com/turnstile/get-started/server-side-validation/#tab-panel-6736)
